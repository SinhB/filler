...
class Game:
	def __init__(self):
		...
		self.label1 = Label(self.root, text=self.player1.generate_label_text(), foreground='cyan', background='black', font='Helvetica 18 bold')
		self.label1.pack(padx=50, pady=10, side=LEFT)
		self.label2 = Label(self.root, text=self.player2.generate_label_text(), foreground='purple', background='black', font='Helvetica 18 bold')
